...
class ItK8sApiAccessControl {
  ...
  @DisplayName("Set domainNamespaceSelectionStrategy to Dedicated for the Operator Helm Chart and "
      + "verify that the domain deployed in the operator's namespace comes up and list domains")
  public void listDomainsViaOperatorRESTInterface() {
    // install and verify operator
    logger.info("Installing and verifying operator");
    installAndVerifyOperator(opNamespace, opNamespace + "-sa",
        true, 0, opHelmParams, domainNamespaceSelectionStrategy,
        false, domain1Namespace);
    ...
    oracle.weblogic.kubernetes.actions.impl.Domain.listDomainsWithRestApi(
        externalRestHttpsPort, "default", "default");
    //oracle.weblogic.kubernetes.actions.impl.Domain.listDomainsWithRestApi(
